...
public class UserController extends BaseController
{
    ...
    /*@RequiresPermissions("system:user:list")是shiro的使用*/
...
/////////////////////////
       ...
       /* (key,val)  下面是只取角色==2的小區住戶 ？？？？*/
        params.put("dataScope","and (sys_role.role_id=2 or sys_role.role_id is NULL)");
...
////////////////
    ...
    /**
     * 新增保存用户
     * @Log(title = "用户管理", businessType = BusinessType.INSERT)是操作日誌表的插入處理
     */
    ...
    /**
     * 修改用户
     * @PathVariable("userId")是取/edit/{userId}中的{userId}的userId值
     */
    @GetMapping("/edit/{userId}")
    public String edit(@PathVariable("userId") Long userId, ModelMap mmap)
    {
 /*下面mmap是将值放入key中，key与edit.html页面中的user和roles对应*/
    ...
    /**
     * 校验用户名
     *  @ResponseBody如果是String就返回字符串，如果是map就返回json
     */
